...
try {
    ...
    $deleteStmt = $pdo->prepare('DELETE FROM requests WHERE id = :id AND association_id = :association_id');
    $deleteStmt->execute([':id' => $requestId, ':association_id' => $association['id']]);
